...
import wx
import trapecioCompuesto as tc
# begin wxGlade: extracode
# end wxGlade


class trapeciocompuesto(wx.Frame):
	def __init__(self, *args, **kwds):
		# begin wxGlade: trapeciocompuesto.__init__
		...
		self.Bind(wx.EVT_BUTTON, self.call_trapeciocompuesto, self.button_1)
		# end wxGlade

	def __set_properties(self):
		# begin wxGlade: trapeciocompuesto.__set_properties
		self.SetTitle("TrapecioCompuesto")
		# end wxGlade

	def __do_layout(self):
		# begin wxGlade: trapeciocompuesto.__do_layout
	...
	def call_trapeciocompuesto(self, event):  # wxGlade: main.<event_handler>
		var = tc.TrapecioComp(str(self.text_ctrl_1.GetValue()),float(self.text_ctrl_3.GetValue()),float(self.text_ctrl_2.GetValue()),int(self.text_ctrl_4.GetValue()))
		var.graph()
		event.Skip()