...
import wx
import simpson3_8 as s38
# begin wxGlade: extracode
# end wxGlade


class simpson38(wx.Frame):
	def __init__(self, *args, **kwds):
		# begin wxGlade: simpson38.__init__
		...
		self.Bind(wx.EVT_BUTTON, self.call_simpson38, self.button_1)
		# end wxGlade

	def __set_properties(self):
		# begin wxGlade: simpson38.__set_properties
		self.SetTitle("Simpson 3/8")
		# end wxGlade

	def __do_layout(self):
		# begin wxGlade: simpson38.__do_layout
	...
	def call_simpson38(self, event):  # wxGlade: main.<event_handler>
		var = s38.Simpson38(str(self.text_ctrl_1.GetValue()),float(self.text_ctrl_3.GetValue()),float(self.text_ctrl_2.GetValue()))
		var.graph()
		event.Skip()