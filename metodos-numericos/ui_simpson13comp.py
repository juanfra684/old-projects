...
import wx
import simpson1_3Compuesto as s13c
# begin wxGlade: extracode
# end wxGlade


class simpson13comp(wx.Frame):
	def __init__(self, *args, **kwds):
		# begin wxGlade: simpson13comp.__init__
		...
		self.Bind(wx.EVT_BUTTON, self.call_simpson13comp, self.button_1)
		# end wxGlade

	def __set_properties(self):
		# begin wxGlade: simpson13comp.__set_properties
		self.SetTitle("Simpson 1/3 Compuesto")
		# end wxGlade

	def __do_layout(self):
		# begin wxGlade: simpson13comp.__do_layout
	...
	def call_simpson13comp(self, event):  # wxGlade: main.<event_handler>
		var = s13c.Simpson13Comp(str(self.text_ctrl_1.GetValue()),float(self.text_ctrl_3.GetValue()),float(self.text_ctrl_2.GetValue()),int(self.text_ctrl_4.GetValue()))
		var.graph()
		event.Skip()