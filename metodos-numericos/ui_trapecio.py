...
import wx
import trapecio as t
# begin wxGlade: extracode
# end wxGlade


class trapecio(wx.Frame):
	def __init__(self, *args, **kwds):
		# begin wxGlade: trapecio.__init__
		...
		self.Bind(wx.EVT_BUTTON, self.call_trapecio, self.button_1)
		# end wxGlade

	def __set_properties(self):
		# begin wxGlade: trapecio.__set_properties
		self.SetTitle("Trapecio")
		# end wxGlade

	def __do_layout(self):
		# begin wxGlade: trapecio.__do_layout
	...
	def call_trapecio(self, event):  # wxGlade: main.<event_handler>
		var = t.Trapecio(str(self.text_ctrl_1.GetValue()),float(self.text_ctrl_3.GetValue()),float(self.text_ctrl_2.GetValue()))
		var.graph()
		event.Skip()