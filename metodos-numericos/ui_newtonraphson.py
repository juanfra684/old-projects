...
class newtonraphson(wx.Frame):
	def __init__(self, *args, **kwds):
		# begin wxGlade: newtonraphson.__init__
		kwds["style"] = wx.DEFAULT_FRAME_STYLE
		wx.Frame.__init__(self, *args, **kwds)
		self.label_1 = wx.StaticText(self, -1, "Funcion")
		self.text_ctrl_1 = wx.TextCtrl(self, -1, "")
		#self.label_2 = wx.StaticText(self, -1, "Limite Inferior")
		#self.text_ctrl_2 = wx.TextCtrl(self, -1, "")
		self.label_3 = wx.StaticText(self, -1, "Punto inicial")
		...
		self.Bind(wx.EVT_BUTTON, self.call_newtonraphson, self.button_1)
		# end wxGlade

	def __set_properties(self):
		# begin wxGlade: newtonraphson.__set_properties
		self.SetTitle("NewtonRaphson")
		# end wxGlade

	def __do_layout(self):
		# begin wxGlade: newtonraphson.__do_layout
	...
	def call_newtonraphson(self, event):  # wxGlade: main.<event_handler>
		var = nr.NewtonRaphson(str(self.text_ctrl_1.GetValue()),float(self.text_ctrl_3.GetValue()),float(self.text_ctrl_4.GetValue()))
		var.graph()
		event.Skip()