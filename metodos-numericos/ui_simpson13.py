...
import wx
import simpson1_3 as s13
# begin wxGlade: extracode
# end wxGlade


class simpson13(wx.Frame):
	def __init__(self, *args, **kwds):
		# begin wxGlade: simpson13.__init__
		...
		self.Bind(wx.EVT_BUTTON, self.call_simpson13, self.button_1)
		# end wxGlade
		
	def __set_properties(self):
		# begin wxGlade: simpson13.__set_properties
		self.SetTitle("Simpson 1/3")
		# end wxGlade
		
	def __do_layout(self):
		# begin wxGlade: simpson13.__do_layout
		...
		self.Layout()
		# end wxGlade
	def call_simpson13(self, event):  # wxGlade: main.<event_handler>
		var = s13.Simpson13(str(self.text_ctrl_1.GetValue()),float(self.text_ctrl_3.GetValue()),float(self.text_ctrl_2.GetValue()))
		var.graph()
		event.Skip()